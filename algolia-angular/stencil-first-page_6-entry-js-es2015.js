...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "first_page", function() { return FirstPage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s_cnt_faq_block_header", function() { return SCntFaqBlockHeader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s_cnt_faq_blocks", function() { return SCntFaqBlocks; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s_cnt_faq_header", function() { return SCntFaqHeader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s_cnt_faq_search", function() { return SCntFaqSearch; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s_cnt_faq_search_pop_up", function() { return SCntFaqSearchPopUp; });
/* harmony import */ var _index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-6c3a0dc7.js */ "./node_modules/faq-algolia/dist/esm/index-6c3a0dc7.js");
...
const firstPageCss = ".sc-first-page-h{display:block}";

const FirstPage = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("s-cnt-faq-header", { header: header, onClickBack: (item) => clicked(item.detail) }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("s-cnt-faq-search", { menu: searchMenu, category: category, logo: logo, placeHolder: placeHolder, searchHints: blocks, onClickMenu: (item) => clicked(item.detail), onClickSearchHint: (item) => clicked(item.detail), onClickSearch: (item) => clicked(item.detail), onClickLogo: (item) => clicked(item.detail), onClickCategory: (item) => clicked(item.detail), onInputValueDown: (item) => clicked(item.detail), onInputValueUp: (item) => clicked(item.detail) }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("s-cnt-faq-block-header", { blockHeader: blockHeader, onClickLink: (item) => clicked(item.detail), onClickRight: (item) => clicked(item.detail), onClickLeft: (item) => clicked(item.detail) }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "my_container" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "row" }, blocks.map(item => {
            return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("s-cnt-faq-blocks", { class: "col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12", blocks: item, onClickBlockHeader: (item) => clicked(item.detail), onClickBlockText: (item) => clicked(item.detail), onClickBlockAuthor: (item) => clicked(item.detail), onClickBlockImg: (item) => clicked(item.detail) }));
        }))), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("s-cnt-faq-search-pop-up", { searchHintsData: blocks, searchPlace: placeholderValue, onClickBlackBlock: (item) => clicked(item.detail), onClickSearchPop: (item) => clicked(item.detail), onClickHints: (item) => clicked(item.detail), onSearchKeyDown: (item) => clicked(item.detail), onSearchKeyUp: (item) => clicked(item.detail) })));
    }
};
FirstPage.style = firstPageCss;

const sCntFaqBlockHeaderCss = ".header.sc-s-cnt-faq-block-header{font-weight:400;font-size:24px;color:#3A416F}.header.sc-s-cnt-faq-block-header:empty{width:47px;height:36px;background-color:#f5f5fa;border-radius:2px;-webkit-animation:loading 1s infinite ease-in-out}.header.sc-s-cnt-faq-block-header:empty{background-color:#ccc;-webkit-animation:loading 1s infinite ease-in-out}.result.sc-s-cnt-faq-block-header{color:#848ab8;font-size:14px;margin:0}.result_btn.sc-s-cnt-faq-block-header{width:25px;height:25px;font-size:9px;border-radius:2px;border-width:1px;border-color:#c5c9e0;-webkit-appearance:none;background:-webkit-gradient(linear, left top, left bottom, from(rgb(255, 255, 255)), to(rgb(249, 250, 251)));background:linear-gradient(rgb(255, 255, 255), rgb(249, 250, 251))}.result_page.sc-s-cnt-faq-block-header{font-size:14px;font-weight:400}.result_link.sc-s-cnt-faq-block-header{text-transform:uppercase;font-size:13px;font-weight:700;color:#5468ff}@media only screen and (max-width: 991px ){.result_btn.sc-s-cnt-faq-block-header,.result_page.sc-s-cnt-faq-block-header,.result_link.sc-s-cnt-faq-block-header{display:none}}@-webkit-keyframes loading{0%{background-color:#f5f5fa}50%{background-color:#fefefe}100%{background-color:#f5f5fa}}@keyframes loading{0%{background-color:#f5f5fa}50%{background-color:#fefefe}100%{background-color:#f5f5fa}}";

const SCntFaqBlockHeader = class {
    constructor(hostRef) {
        Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["r"])(this, hostRef);
        /**
    ...
    render() {
        if (this.blockHeader.length !== 0) {
            return (this.blockHeader.map(item => {
                return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "my_container" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "header_block d-flex justify-content-between mb-5" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "header" }, item.header), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "results d-flex align-items-center" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("p", { class: "result" }, item.results, " ", this.result(item)), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "result_buttons ml-2" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { disabled: this.checkDisableL(item), class: "result_btn", onClick: () => {
                        this.clickLeft.emit({ place: 'left arrow', item: item });
                        {
                            item.pageActive = item.pageActive - 1;
                            this.counterPage = item.pageActive;
                        }
                    } }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "fas fa-arrow-left" })), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { class: "result_btn", disabled: this.checkDisableR(item), onClick: () => {
                        this.clickRight.emit({ place: 'right arrow', item: item });
                        {
                            item.pageActive = item.pageActive + 1;
                            this.counterPage = item.pageActive;
                        }
                    } }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "fas fa-arrow-right" }))), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "result_page ml-3" }, item.pageActive, "-", item.resultPages), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "result_link ml-3 clicked", onClick: () => this.clickLink.emit({ place: 'link', item: item }) }, item.link, "  ", Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "fas fa-caret-right" })))))));
            }));
        }
        return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "my_container d-flex" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "m-auto not_data text-focus-in p-3" }, "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445")));
    }
    /**
...
const SCntFaqBlocks = class {
    constructor(hostRef) {
         ...
         */
        this.getAction = (item) => {
            return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "action" }, item.authorAction));
        };
    ...
    render() {
        if (this.blocks) {
            return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "block" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "info" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "img clicked", onClick: () => this.clickBlockImg.emit({ place: 'img', item: this.blocks }), style: { backgroundImage: "url(" + this.blocks.img + ")" } }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "header clicked", onClick: () => this.clickBlockHeader.emit({ place: 'header', item: this.blocks }), innerHTML: this.blocks.header }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "text clicked", onClick: () => this.clickBlockText.emit({ place: 'text', item: this.blocks }), innerHTML: this.blocks.text })), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "author d-flex align-items-center clicked", onClick: () => this.clickBlockAuthor.emit({ place: 'author', item: this.blocks }) }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "author_img", style: { backgroundImage: "url(" + this.blocks.authorAvatar + ")" } }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "author_info" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "name" }, this.blocks.authorName), this.getAction(this.blocks)))));
        }
        return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "my_container d-flex" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "m-auto not_data text-focus-in" }, "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445")));
    }
};
SCntFaqBlocks.style = sCntFaqBlocksCss;

const sCntFaqHeaderCss = ".back_block.sc-s-cnt-faq-header{width:25px;height:25px;text-align:center;color:#5d6494;font-weight:400;font-size:14px}.back.sc-s-cnt-faq-header{font-weight:400;font-size:18px}.header_block.sc-s-cnt-faq-header{padding:48px 0;max-width:100%}h1.sc-s-cnt-faq-header{font-weight:400;color:#3A416F;font-size:36px}h1.sc-s-cnt-faq-header:empty{width:350px;height:40px;background-color:#f5f5fa;border-radius:2px;-webkit-animation:loading 1s infinite ease-in-out}.back_adaptive.sc-s-cnt-faq-header{display:none}.bottom_block.sc-s-cnt-faq-header{display:none}@media only screen and (max-width: 991px ){.back_adaptive.sc-s-cnt-faq-header{text-align:center;display:block;position:fixed;bottom:20px;z-index:5;left:50%;-webkit-transform:translate(-50%, 0);transform:translate(-50%, 0);width:60px;height:60px;border-radius:50%;color:white;background-color:#3a416f;-webkit-box-shadow:0 5px 15px 0 rgba(37,44,97,.15), 0 2px 4px 0 rgba(93,100,148,.2);box-shadow:0 5px 15px 0 rgba(37,44,97,.15), 0 2px 4px 0 rgba(93,100,148,.2)}.back_in.sc-s-cnt-faq-header{display:-ms-flexbox;display:flex;width:inherit;height:inherit;border-radius:inherit;font-size:25px}.bottom_block.sc-s-cnt-faq-header{z-index:5;display:block;background-image:-webkit-gradient( linear,left top, left bottom,from(rgba(255,255,255,0)),color-stop(65%, rgb(255,255,255)),to(rgb(255,255,255)) );background-image:linear-gradient( -180deg,rgba(255,255,255,0) 0%,rgb(255,255,255) 65%,rgb(255,255,255) 100% );height:100px;width:100%;position:fixed;right:0;left:0;bottom:0}.header_block.sc-s-cnt-faq-header{display:none !important}}";

const SCntFaqHeader = class {
    constructor(hostRef) {
        Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["r"])(this, hostRef);
        this.header = [];
    ...
    render() {
        if (this.header.length !== 0) {
            return (this.header.map(item => {
                return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "my_container" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "header_block d-flex justify-content-between" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("h1", null, item.header)), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "back_block clicked", onClick: () => this.clickBack.emit('Back') }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "back" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "fas fa-times" })), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, "esc"))), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "bottom_block" }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "back_adaptive clicked", onClick: () => this.clickBack.emit('Back') }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "back_in" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "m-auto" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "fas fa-times" }))))));
            }));
        }
        return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "my_container d-flex" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "m-auto not_data text-focus-in p-3" }, "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445")));
    }
...
const SCntFaqSearch = class {
    constructor(hostRef) {
        ...
        this.getLink = (props) => {
            ...
            return (item.map(item => {
                ...
                return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("li", null, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: item.active ? 'menu_item clicked activeLink' : 'menu_item clicked', onClick: () => {
                        this.clickMenu.emit({ place: 'Menu', item: item });
         ...
         */
        this.getCategory = (props) => {
            let item = props.slice(0, 9);
            return (item.map(item => {
                if (this.activeCategory !== item.id) {
                    item.active = false;
                }
                return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("li", { class: "flex-grow-1" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: item.active ? 'hints clicked activeHints' : 'hints clicked', onClick: () => {
                        this.clickCategory.emit({ place: 'Category', item: item });
        ...
        this.getLogo = (props) => {
            ...
            return (item.map(item => {
                return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "search_img", onClick: () => this.clickLogo.emit({ place: 'logo', item: item }), style: { backgroundImage: "url(" + item.link + ")" } }));
            }));
        };
        /**
         * Поучение данных о поисковых подсказках
         */
        this.getSearchHints = (props) => {
            return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, props.map(item => {
                return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "search_hints clicked", onClick: () => { this.clickSearchHint.emit({ place: 'Search hint', item: item }); this.innerSearchHints = item.header; } }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "d-flex align-items-center" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "hints_img mr-3", style: { backgroundImage: "url(" + item.img + ")" } }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "hints_text", innerHTML: item.header }, "...")), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "hints_select d-flex" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "fas fa-level-down-alt" })))));
            })));
        };
        /**
         ...
         */
        this.notDataSearch = () => {
            return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "search_hints" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "d-flex align-items-center" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "hints_text text-muted" }, "\u041D\u0438\u0447\u0435\u0433\u043E \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E")), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null)));
        };
    ...
    render() {
        return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "my_container" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "search_block" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "row" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "col-xl-4 col-lg-4 col-md-6 col-sm-8 col-12" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ul", { class: "menu d-flex justify-content-between" }, this.menu ? this.getLink(this.menu) : '')))), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { ref: (el) => this.ourInputBlock = el, class: "input_section d-flex align-items-center justify-content-between" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "search_btn clicked", onClick: () => this.clickSearch.emit('Search') }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "fas fa-search" })), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "flex-grow-1" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { value: parseHtmlToFragment(this.innerSearchHints).innerText, ref: (el) => this.ourInput = el, onFocus: (event) => this.animationInput(event), onKeyDown: () => this.inputValueDown.emit({ 'search': event }), onKeyUp: () => this.inputValueUp.emit({ 'search': event }), class: "input_block", type: "text", placeholder: this.placeHolder ? this.placeHolder : '' })), this.logo ? this.getLogo(this.logo) : ''), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "parent_search_hints" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: this.searchHintsVisible ? 'second_hints_parent' : 'second_hints_parent_hidden' }, this.searchHints ? this.getSearchHints(this.searchHints) : this.notDataSearch())), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "category" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ul", { class: "category_list d-flex" }, this.category ? this.getCategory(this.category) : ''))));
    }
    /**
...
const SCntFaqSearchPopUp = class {
    constructor(hostRef) {
        ...
        this.getSearchHints = (props) => {
            ...
            return (item.map(item => {
                return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { ref: (el) => this.ourSearchHintBlock = el, onClick: () => { this.clickHints.emit({ place: 'Search hint', item: item }); this.searchFormValue = item.header; this.hideHints(); }, class: "paren_hints clicked" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "search_hint_img mr-3", style: { backgroundImage: "url(" + item.img + ")" } }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "search_hint_text", innerHTML: item.header }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "select" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "fas fa-level-down-alt" }))));
            }));
        };
        /**
         * Поучение данных placeholder
         */
        this.getSearchPlace = (props) => {
            let item = props.slice(0, 1);
            return (item.map(item => {
                return item.text;
            }));
    ...
    render() {
        return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "main_search" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "black", onClick: () => this.clickBlackBlock.emit('black block'), ref: (el) => this.ourBlackBlock = el }), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "input_parent" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "input_search", ref: (el) => this.ourInputFormBlock = el }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "input_btn clicked", onClick: () => this.clickSearchPop.emit('Search') }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "fas fa-search" })), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "flex-grow-1" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { onKeyDown: () => this.searchKeyDown.emit({ 'search': event }), onKeyUp: () => this.searchKeyUp.emit({ 'search': event }), value: parseHtmlToFragment(this.searchFormValue).innerText, onFocus: () => this.animationSearch(), ref: (el) => this.ourInputForm = el, class: "input_form", type: "text", placeholder: this.searchPlace ? this.getSearchPlace(this.searchPlace) : '' })), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "main_hints", ref: (el) => this.ourHintsBlock = el }, this.checkData() ? this.getSearchHints(this.searchHintsData) : this.notDataSearch()))), Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "backAnim clicked", onClick: () => { this.clickBackAnim.emit('Back'); this.hideHints(); } }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "back_in_anim" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "m-auto" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("i", { class: "fas fa-times" }))))));
    }
    /**
     ...
     */
    notDataSearch() {
        return (Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "paren_hints clicked", onClick: () => this.hideHints() }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "d-flex align-items-center" }, Object(_index_6c3a0dc7_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "search_hint_text" }, "\u041D\u0438\u0447\u0435\u0433\u043E \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E"))));
    }
};
...
//# sourceMappingURL=stencil-first-page_6-entry-js-es2015.js.map